...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broken-union-61f7
```

A live public deployment of this template is available at [https://broken-union-61f7.templates.workers.dev](https://broken-union-61f7.templates.workers.dev)
